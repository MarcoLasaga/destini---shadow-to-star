  ...
  return (
    ...
    >
      <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center', paddingTop: 40 }}>
        ...
        <h1 className="page-title-lg">Privacy Policy</h1>

        <p style={{ fontFamily: FF, fontSize: 16, color: 'var(--text-body)', lineHeight: 1.7, maxWidth: 560, margin: '20px auto 8px' }}>
          This page is currently being prepared and will provide detailed information about how StyleSense collects, uses, stores, and protects your data — including your wardrobe photos, location information, and outfit history.
        </p>
        <p style={{ fontFamily: FF, fontSize: 14, color: 'var(--text-muted)', marginTop: 12 }}>
          Check back soon for the full policy.
        </p>
